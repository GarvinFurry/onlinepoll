...
<?php
    ...
    define('TITLE',"Dashboard| Adun Poll Forum");

    $companyName = "Admiralty University";
            ...
            <div class="container-fluid">
                <div class="row">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="forum" role="tabpanel" aria-labelledby="forum-tab">
                                ...
                                <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm">
                                  ...
                                  <div class="lh-100">
                                    <h1 class="mb-0 align-items-center text-white lh-100">Latest Forums</h1>
                                  </div>
                                </div>  
                    ...
                    <div class="col-sm-2">
                        ...
                        <a href="forum.php" class="btn btn-warning btn-lg btn-block">ADUN Forum</a>
                        <a href="hub.php" class="btn btn-secondary btn-lg btn-block">ADUN Hub</a>
                        <br><br><br>
