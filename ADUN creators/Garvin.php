				...
				<div class="col-md-10 col-lg-8">
					<div class="intro">
						...
						<ul class="social-icons">
							<li><a href="https://github.com/GarvinFurry" target="_blank">
                                                                <i class="fa fa-github"></i></a></li>
							<li><a href="https://www.linkedin.com/in/Garvin Animam/" target="_blank">
                                                                <i class="fa fa-linkedin"></i></a></li>
							<li><a href="https://web.facebook.com/Garvin Walker" target="_blank">
			...
			<div class="row">
				...
				<div class="col-md-12 col-lg-6">
					...
					<div class="line-progress margin-b-20" data-prog-percent=".85"><div></div>
                                            <p class="progress-title"><b>Gaming</b></p></div><br>
					...
					<div class="panel margin-b-30">
						...
						<div class="panel-area margin-b-30">
							<h5 class="panel-title"><b>Machine Learning</b>
								<i class="icon minus ion-minus"></i><i class="icon plus ion-plus"></i></h5>
							<p class="panel-desc">Currently an aspiring Computer Science student,
        ...
        <section class="content-section" id="portfolio">
          <div class="container">
            ...
            <div class="row no-gutters">
              <div class="col-lg-6">
                <a class="portfolio-item" href="https://www.adun.edu.ng" target="_blank">
                  <span class="caption">
                    <span class="caption-content">
                      <h2>NIMUN'19</h2>
                      <p class="mb-0 text-white">Official website for Admiralty University<br>
                      Of Nigeria (ADUN)</p>
                    </span>
                  </span>
              ...
              <div class="col-lg-6">
                <a class="portfolio-item" href="https://github.com/GarvinFurry" target="_blank">
                  <span class="caption">
                    <span class="caption-content">
              ...
              <div class="col-lg-6">
                <a class="portfolio-item" href="https://github.com/GarvinFurry">
                  <span class="caption">
                    <span class="caption-content">
                      <h2>ADUN</h2>
